...
There are different levels of these versions, if a higher level version (eg: `global`) has not changed, lower level versions (eg: `rendered`) will also not have changed.
